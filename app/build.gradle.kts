...
// contains an internal `myArrayList` field absent from the platform class. Excluding the artefact
// globally ensures only the platform class is ever referenced.
